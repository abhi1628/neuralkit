    ...
    <div className="hero-logo-mark" style={{ position: 'relative', width: '130px', height: '130px', margin: '0 auto 36px' }}>
      ...
      <svg width="130" height="130" viewBox="0 0 130 130" xmlns="http://www.w3.org/2000/svg" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <g className="hero-logo-ring">
          <circle cx="65" cy="65" r="58" fill="none" stroke="url(#hg1)" strokeWidth="2.5" strokeDasharray="240 90" strokeLinecap="round" />
        ...
        <g className="hero-logo-ring2">
          <circle cx="65" cy="65" r="42" fill="none" stroke="url(#hg2)" strokeWidth="1.5" strokeDasharray="160 60" strokeLinecap="round" opacity="0.7" />
        ...
        <circle cx="65" cy="65" r="28" fill={isDark ? 'rgba(167,139,250,0.1)' : 'rgba(124,58,237,0.08)'} stroke="url(#hg1)" strokeWidth="1" />
        <text x="65" y="59" textAnchor="middle" fontFamily="'Arial Black', sans-serif" fontSize="28" fontWeight="900" fill="url(#hg1)">0</text>
        <text x="65" y="78" textAnchor="middle" fontFamily="monospace" fontSize="11" fill={isDark ? 'rgba(241,245,249,0.7)' : 'rgba(30,27,75,0.7)'} letterSpacing="4" fontWeight="700">API</text>
      </svg>
    </div>
  );
}
