  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', fontFamily: "'DM Sans', sans-serif", padding: '100px 32px 80px' }}>
      <div style={{ maxWidth: '960px', margin: '0 auto' }}>
       {/* Back to ZeroAPI */}
        <button onClick={() => navigate('/')} style={{ background: isDark ? 'rgba(167,139,250,0.08)' : 'rgba(124,58,237,0.07)', border: isDark ? '1px solid rgba(167,139,250,0.2)' : '1px solid rgba(124,58,237,0.2)', borderRadius: '8px', color: ac, fontSize: '0.82rem', cursor: 'pointer', fontFamily: "'Space Mono',monospace", marginBottom: '36px', display: 'flex', alignItems: 'center', gap: '6px', padding: '8px 16px', fontWeight: 600 }}>
          ← Back to ZeroAPI
        </button> 
        {/* Header */}
        <div style={{ textAlign: 'center', marginBottom: '56px' }}>
          ...
          <h1 style={{ fontFamily: "'Syne',sans-serif", fontSize: 'clamp(2rem,5vw,3.2rem)', fontWeight: 800, letterSpacing: '-0.03em', color: isDark ? '#fff' : '#1a1a1a', marginBottom: '14px' }}>
            Learning Roadmaps
          </h1>
          <p style={{ color: isDark ? 'rgba(255,255,255,0.45)' : 'rgba(0,0,0,0.6)', fontSize: '1rem', fontWeight: 300, maxWidth: '560px', margin: '0 auto', lineHeight: 1.7 }}>
          ...
          {ROADMAPS.map(roadmap => (
            <div
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.boxShadow = isDark ? '0 8px 32px rgba(167,139,250,0.12)' : '0 8px 32px rgba(124,58,237,0.1)';
              }}
              onMouseLeave={e => {
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '16px' }}>
                <span style={{ fontSize: '2rem' }}>{roadmap.icon}</span>
                <div>
                  <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 700, fontSize: '1.05rem', color: isDark ? '#fff' : '#1a1a1a' }}>
                    {roadmap.title}
                  </div>
                  <div style={{ fontSize: '0.72rem', color: ac, fontFamily: "'Space Mono',monospace", marginTop: '2px' }}>
                    {roadmap.category} · {roadmap.estimatedHours}+ hours
                  </div>
                </div>
              </div>
              
              <p style={{ color: isDark ? 'rgba(255,255,255,0.55)' : 'rgba(0,0,0,0.6)', fontSize: '0.88rem', lineHeight: 1.7, marginBottom: '18px' }}>
                {roadmap.description}
              </p>
