...
const CHALLENGE_CATEGORIES = [
  ...
  },
  {
      ...
      color: "#00bce4",
      challenges: [
      { slug: "cisco-async-leak", title: "The Dangling Thread Pool Leak", level: "advanced", time: "6 min", solves: 2405, description: "[Cisco Ideathon 2025] Telemetry thread workers leak memory across connection refreshes during router monitoring simulations.", theorySlug: "python-network-concurrency" },
      { slug: "cisco-packet-race", title: "The Packet Buffer Out-Of-Bounds", level: "advanced", time: "8 min", solves: 1102, description: "[Cisco Ideathon 2025] High-throughput async routers process packet fragments out of sequence under micro-burst traffic loads.", theorySlug: "defensive-cpp-memory-management" },
      { slug: "cisco-subnet-overflow", title: "The Classless Subnet Overflow", level: "intermediate", time: "5 min", solves: 1890, description: "[Cisco Ideathon 2024] A custom bitwise IP configuration parser crashes completely on specific edge-case subnet masks.", theorySlug: "low-level-bitwise-networking" },
      { slug: "cisco-unhandled-rejection", title: "The Python Connection Hang", level: "intermediate", time: "4 min", solves: 3120, description: "[Interview Technical Round] Backend automation scripts hang forever when a physical networking device drops connections abruptly.", theorySlug: "handling-hardware-network-timeouts" },
      { slug: "cisco-deadlock-queue", title: "The Thread Lock Deadlock", level: "advanced", time: "7 min", solves: 894, description: "[Cisco Ideathon 2023] Parallel packet analytical components lock up indefinitely trying to access shared telemetry streams.", theorySlug: "concurrency-deadlock-prevention" },
      { slug: "cisco-slowloris-timeout", title: "The Un-Timed Socket Starvation", level: "intermediate", time: "5 min", solves: 1450, description: "[Cisco Ideathon 2024] Network load balancer keeps connections open forever when attackers send partial HTTP headers.", theorySlug: "resilient-socket-programming" },
      { slug: "cisco-checksum-failure", title: "The Malformed Checksum Matcher", level: "beginner", time: "3 min", solves: 4120, description: "[Cisco Track] Base-16 hexadecimal frame verification returns false due to un-trimmed string allocations.", theorySlug: "data-sanitization-techniques" },
      { slug: "cisco-token-bucket", title: "The Racing Rate Limiter", level: "advanced", time: "6 min", solves: 978, description: "[Cisco Ideathon 2025] High-speed gateway bypass lets traffic slip past strict packet-per-second constraints.", theorySlug: "thread-safety-in-python" },
      { slug: "cisco-dangling-pool", title: "The Orphaned Process Leak", level: "advanced", time: "9 min", solves: 531, description: "[Interview System Round] Background packet analyzer sub-processes remain allocated without releasing system process tracks.", theorySlug: "advanced-python-multiprocessing" },
      { slug: "cisco-dns-cache-poison", title: "The Un-Indexed Array Lookup Bottleneck", level: "intermediate", time: "6 min", solves: 1340, description: "[Cisco Ideathon 2024] Sequential routing configuration table scans cause high latency on high-throughput data gateways.", theorySlug: "cpp-data-structure-performance" }
    ]
    },
    ...
    },
  {
    ...
    color: "#ec4899",
    challenges: [
      { slug: "cloud-iam-exposure", title: "The Over-Privileged S3 Bucket", level: "intermediate", time: "5 min", solves: 1420, description: "[AWS Cloud Track] A misconfigured resource policy exposes proprietary system assets to anonymous external domains.", theorySlug: "iam-security-best-practices" },
      { slug: "cloud-cors-wildcard", title: "The Open Vault Gateway", level: "intermediate", time: "4 min", solves: 1980, description: "[Production Gateway] Combining global origin wildcards with active credential configurations triggers browser blocks.", theorySlug: "mastering-cors-architectures" },
      { slug: "cloud-ssrf-metadata", title: "The Metadata Siphon", level: "advanced", time: "7 min", solves: 890, description: "[Systems Security] Un-sanitized proxy parameters allow attackers to extract internal server credentials.", theorySlug: "preventing-ssrf-vulnerabilities" },
      { slug: "cloud-docker-root", title: "The Root Privilege Breach", level: "beginner", time: "3 min", solves: 3410, description: "[Dockerfile Optimization] Building container runtime environments without restricted service users violates least-privilege standards.", theorySlug: "hardening-docker-containers" },
      { slug: "cloud-zombie-pid", title: "The Zombie Process Apocalypse", level: "advanced", time: "7 min", solves: 645, description: "[Container Engineering] Running standalone scripts under PID 1 leaks dead child threads inside host runtimes.", theorySlug: "container-process-lifecycles" },
      { slug: "cloud-k8s-spiral", title: "The Liveness Probe Death Spiral", level: "advanced", time: "8 min", solves: 720, description: "[Kubernetes Architecture] Pointing automated node health monitoring to heavy processing lanes triggers false restart loops.", theorySlug: "kubernetes-probe-orchestration" },
      { slug: "cloud-thundering-herd", title: "The Thundering Herd Avalanche", level: "advanced", time: "6 min", solves: 1130, description: "[Cache Strategy] Simultaneous global key expirations trigger overwhelming traffic floods on downstream backends.", theorySlug: "caching-strategies-at-scale" },
      { slug: "cloud-retry-storm", title: "The Cascading Retry Storm", level: "intermediate", time: "5 min", solves: 2240, description: "[Microservice Dynamics] Blind immediate network retry loops multiply a minor timeout glitch into a system-wide outage.", theorySlug: "resilient-microservice-architectures" },
